...
So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-croatian-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `hr_HR.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `hr_HR.csv`, we will not approve it in this case.
