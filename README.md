...
2. [Install Croatian Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Croatian language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Croatian language pack {#active}
